        ...
        <div className="mx-auto w-full max-w-[1680px] px-4 py-10 sm:px-8 lg:px-10 lg:py-12">
          <div className="overflow-hidden rounded-[32px] bg-gradient-to-r from-slate-900 via-slate-800 to-blue-900 shadow-[0_24px_50px_-24px_rgba(15,23,42,0.55)]">
            <div className="grid gap-6 px-5 py-7 sm:px-6 sm:py-8 lg:grid-cols-[minmax(0,1.25fr)_400px] lg:gap-8 lg:px-8 lg:py-10 xl:gap-12 xl:px-10 xl:py-12">
              ...
              <div className="relative hidden min-h-[260px] overflow-hidden rounded-[28px] border border-white/10 bg-white/10 lg:block xl:min-h-[340px]">
                <Image
                  src={previewImage}
                  alt={selectedRange || "Fabric preview"}
          ...
          <div className="mt-8 grid gap-6 xl:grid-cols-[320px_minmax(0,1fr)_280px] xl:gap-8 2xl:grid-cols-[340px_minmax(0,1fr)_300px]">
            ...
            <main className="order-1 xl:order-2">
              ...
              <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-3">
                    ...
                    >
                      {fabric.image ? (
                        ...
                        >
                          ...
                          <div className="absolute left-4 top-4 rounded-full bg-white/90 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-blue-700 shadow-sm">
                            {fabric.rangeName}
                          </div>
