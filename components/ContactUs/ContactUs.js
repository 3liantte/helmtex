  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto p-6 flex flex-col md:flex-row gap-10">
        {/* Contact Form */}
        <div className="md:w-1/2 w-full md:p-8 bg-gray-800 text-white p-8 rounded-lg shadow-lg">
        ...
        <div className="md:w-1/2 flex flex-col gap-8 text-gray-300">
          <p>
            In tempus nisl turpis, at ultricies dui eleifend a. Quisque et quam vel mauris consectetur pharetra euismod et eleifend. Nullam orci purus.
          </p>
          ...
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.2364553909536!2d-122.41941568468166!3d37.77492927975983!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80858064b8e5e4b9%3A0x6e09b6e6b113d7f1!2sSan%20Francisco%2C%20CA%2C%20USA!5e0!3m2!1sen!2sus!4v1619498050912!5m2!1sen!2sus"
            allowFullScreen=""
            loading="lazy"
          />
        </div>
