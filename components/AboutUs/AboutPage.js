        ...
        <div className="max-w-7xl mx-auto flex flex-wrap items-center">
          ...
          <div className="w-full sm:w-1/2 sm:pl-8 mt-6 sm:mt-0">
            ...
            <p className="text-gray-600 mb-6">
              ...
              we have been dedicated to producing high-quality fabrics that meet the diverse needs of our clients. Our commitment to excellence, innovation, and sustainability has earned us a reputation for reliability and craftsmanship.
      ...
      <section className="py-16 px-8">
        <div className="text-center mb-10">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-4">Why Choose Us</h2>
           <p className="text-gray-600 mb-6">
                With an extensive inventory of high-quality fabrics, 
                competitive wholesale pricing, and immediate availability, we empower businesses to meet their production timelines without hassle. 
                Our strategically located warehouse ensures timely delivery, and our experienced team is committed to providing 
                exceptional service and tailored solutions for your business.
            </p>
        </div>
